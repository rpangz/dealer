                                        ...
                                        <div class="col-md-6 text-left">
                                            <form class="form-horizontal" role="form">                                    
                                                <div class="form-group">
                                                    <label class="col-md-3">Nama Department</label>
                                                    <div class="col-md-3">
                                                        <input type="text" class="form-control input-sm" value="" id="department" name="department" data-attr="input_data">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3">Status Department</label>
                                                    <div class="col-sm-5">
