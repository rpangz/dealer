                                    ...
                                    <div class="row">
                                        <div class="col-md-6 text-left">
                                            <form class="form-horizontal" role="form">                                    
                                                <div class="form-group">
                                                    <label class="col-md-3">Nama Header</label>
                                                    <div class="col-md-5">
                                                        <input type="text" class="form-control input-sm" value="" id="headername" name="headername" data-attr="input_data">
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-md-3">Icon</label>
                                                    <div class="col-md-4">
                                                        <input type="text" id="glyphicon" name="glyphicon" class="form-control input-sm" value="" data-attr="input_data">
                                                    </div>
                                                </div>
                                        ...
                                        <div class="col-md-6 text-left">
                                            <form class="form-horizontal" role="form">
                                                ...
                                                <div class="form-group">
                                                    <label class="col-md-2">Posisi</label>
                                                    <div class="col-md-3">
                                                        <input type="text" id="ordinal" name="ordinal" class="form-control input-sm text-right" value="" data-attr="input_data">
                                                    </div>
                                                </div>
