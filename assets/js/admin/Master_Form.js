...
function simpan(){
    ...
    $.ajax({
      type: "POST",
      url: "Master_Form/simpan",
      data : {"formname" : formname, "formtitle" : formtitle, "formheader" : formheader, "status" : status, "typeform" : typeform, "editkeyvalue" : editkeyvalue},
    ...
    $.ajax({
      ...
      success: function(data){
      		...
      		for(var i = 0; i < data.length; i++) {
      			...
      			$('#formname').val(data[i].formname);
      			$('#formtitle').val(data[i].formtitle);
      			$('#formheader').val(data[i].formheader);
